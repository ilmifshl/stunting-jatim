  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        if (regionError || !region) throw regionError || new Error('Region not found');
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-gray-500 font-bold uppercase tracking-widest text-xs">Memuat Data {regionName}...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
        <div className="text-center">
          <h1 className="text-2xl font-black text-gray-900 mb-4 tracking-tight">Wilayah Tidak Ditemukan</h1>
  ...
  const factorGroups = [
    {
      ...
      icon: Baby,
      color: 'blue',
      description: 'Determinan yang berkaitan langsung dengan kondisi bayi.',
      items: [
        { label: 'BBLR / Prematur', count: currentFactors?.bblr_count, rate: currentFactors?.bblr_rate, unit: '% Balita' },
        { label: 'Cakupan IMD', count: currentFactors?.imd_count, rate: currentFactors?.imd_rate, unit: '% Bayi' },
        { label: 'ASI Eksklusif', count: currentFactors?.asi_count, rate: currentFactors?.asi_rate, unit: '% Bayi < 6 Bln' },
      ]
    },
    {
      ...
      items: [
        ...
        { label: 'Vitamin A', count: currentFactors?.vita_count, rate: currentFactors?.vita_rate, unit: '% Balita' },
      ]
    },
    {
      ...
      items: [
        ...
        { label: 'Layanan Kes. Catin', count: currentFactors?.catin_count, rate: currentFactors?.catin_rate, unit: '% Catin' },
      ]
    },
    {
      ...
      items: [
        ...
        { label: 'KK SBS (Stop BABS)', count: currentFactors?.stbm_count, rate: currentFactors?.stbm_rate, unit: '% KK' },
      ]
    }
  ];
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                <span className="text-[10px] font-black text-blue-600 uppercase tracking-widest bg-blue-50 px-2 py-0.5 rounded">Profil Analisis Wilayah</span>
              </div>
      ...
      <div className="max-w-[1400px] mx-auto px-4 py-10 space-y-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="flex items-baseline gap-4 mt-2">
                  ...
                  {prevalenceDiff !== null && (
                    <div className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-[10px] font-black uppercase ${prevalenceDiff > 0 ? 'bg-red-50 text-red-600' : 'bg-emerald-50 text-emerald-600'
                      ...
                      {Math.abs(prevalenceDiff)}% Dari {activeYear - 1}
                    </div>
                  )}
                </div>
              </div>
          ...
          <div className="bg-white rounded-[3rem] p-8 border border-slate-200/60 shadow-2xl shadow-blue-900/5 flex flex-col">
            <div className="flex justify-between items-center mb-6">
              ...
              <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Multi-Tahun</span>
            </div>
        ...
        <div className="space-y-8">
          <div className="flex items-center gap-4">
            <h2 className="text-2xl font-black text-gray-900 uppercase tracking-tight">Analisis Determinan Deterministik</h2>
        ...
        <div className="bg-gradient-to-r from-blue-700 to-indigo-800 rounded-[3rem] p-12 text-white shadow-2xl shadow-blue-500/20 flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="max-w-2xl text-center md:text-left">
            <h3 className="text-3xl font-black uppercase tracking-tight leading-tight mb-4">Butuh intervensi spesifik untuk wilayah ini?</h3>
            <p className="text-blue-100 text-sm font-medium leading-relaxed">Analisis stunting tahun {activeYear} menunjukkan determinan terkuat berada pada {factorGroups[0].title}. Segera kordinasikan dengan dinas terkait berdasarkan data granular di atas.</p>
          </div>
